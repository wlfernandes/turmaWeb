...
<body>
	...
	<div class="container">
		...
		<header class="masthead">
			<h1 class="muted">Painel de Gerenciamento de Alunos</h1>
			<nav class="navbar">
			...
			if(isset($_POST['enviar'])){
				...
				$sql  = 'INSERT INTO alunos (nome, cpf, email, fone, data_nascimento)';
				$sql = 'VALUES (:nome, :cpf, :email, :fone, :data_nascimento)';
				...
				try {
					...
					$create->bindValue(':fone', $fone, PDO::PARAM_INT);
            ...
            $sqlUpdate = 'UPDATE alunos SET nome = ?, cpf = ?, email = ?, fone = ?, data_nascimento = ? WHERE id = ?';

			$dados = array($nome, $cpf, $email, $fone, $data_nascimento,  $id);
		...
		<article>
			...
			<section class="jumbotron">
				...
				<form method="post" action="">
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-user"></i></span>
                        <input type="text" name="cpf" value="<?php echo $result->cpf; ?>" placeholder="Cpf:" />
                    </div>
					<div class="input-prepend">
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-user"></i></span>
                        <input type="text" name="fone" value="<?php echo $result->fone; ?>" placeholder="Telefone:" />
                    </div>
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-user"></i></span>
                        <input type="text" name="data_nascimento" value="<?php echo $result->data_nascimento; ?>" placeholder="Data de Nascimento:" />
                    </div>
					<br />
				...
				<form method="post" action="">
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="iconic-headphones"></i></span>
                        <input type="text" name="fone" placeholder="Telefone" />
                    </div>

                    <div class="input-prepend">
                        <span class="add-on"><i class="iconic-clock"></i></span>
